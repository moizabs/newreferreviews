...
<body style=" background-color: #d3ebf8">
    <div class="container-m">
        ...
        <p>You're almost there! we sent an email to <span style="font-weight: 600"> {{ $company_email }} </span></p>
        ...
        <form action="{{ route('company.resend.verification', $company_id) }}" method="POST">
            @csrf
