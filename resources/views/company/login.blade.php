...
<html>
<head>
	<title>Refer Reviews - Company Login</title>
...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="{{ route('company.login.submit') }}" method="POST" onsubmit="return formvalid()" >
                @csrf
				...
				<h2 class="title">Company Login</h2>
           		...
           		<div class="input-div one">
           		   ...
           		   <div class="div">
           		   		<!-- <h5>Email</h5> -->
           		   		<input id="email" type="Email" name="comp_email" class="input" placeholder="Email" autocomplete="off">
            	...
            	<div style="display: flex;flex-direction: row-reverse;justify-content: space-between;">
                	<a href="{{ route('user.login') }}" class="text-info">Login As Customer </a>
                ...
                <div>
                    <a href="{{ route('company.register') }}" class="text-info"> Sign Up</a>
                </div>
                </div>
            </form>
