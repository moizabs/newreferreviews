...
<body>
		...
		<div class="absolute-center" >
			<div class="section" >
				<div class="container">
				    ...
				    <div class="col-lg-6 col-sm-12 col-md-12 ospadop banner-text">
                        <h5>Every review has a significant experience that goes with it.</h5>
                        <p style="    color: #5c5757;
                        margin-bottom: 10px;
                        font-weight: 600;"> 
                        ...
                        <div class="input-group">
                            <input type="text" name="search" class=" typeahead form-control search-input" id="search"
    ...
    <div class="" style="padding:40px 0; position:relative; background-image: url('{{asset('images/bg-elements.webp')}}');" >
                ...
                <div class="item2">
                    <div class="card__box cate_info mb-3">
                        <a href = '/company_search_by_cate_id/{{ $category->id }}' class="hvr-pop">
                            <div>
                            <img src="{{ asset('storage/categoryImage/'.$category->image) }}" alt="" class="caroselimage" style="max-width: 100%; /* height: auto; */ object-fit: cover;">
                            </div>
                            <div class="card__box--txt">
                                <input class='cate_id' type="hidden" name="category_id" value="{{ $category->id }}">
                                <h2>{{ $category->name }}</h2>
                            </div>
                        </a>
                    </div>
                ...
                <div class="item">
                    <div class="card__box cate_info mb-3">
                        <a href='#' class="hvr-pop">
                            <div>
                            <img src="{{ asset('storage/categoryImage/'.$category->image) }}" alt="" style="height: 300px; max-width: 100%; /* height: auto; */ object-fit: cover;">
                            </div>
                            <div class="card__box--txt">
                                <input class='cate_id' type="hidden" name="category_id" value="{{ $category->id }}">
                                <h2>{{ $category->name }}</h2>
                                ...
                                <div class="d-flex testimonials">
                                    ...
                                    <div>
                                        <div class="star-rate d-flex flex-column">
                                            ...
                                            <span class="text-center">Rating {{ $review['rating'] }}/5.0</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="site-main">
                                    ...
                                    <div class="review-author">
                                        ...
                                        <a
                                            href="{{ route('company.show', $review['get_business']['id']) }}">
                                    ...
                                    <span class="review-text">{{ \Illuminate\Support\Str::words($review['review'],25) }}</span>
                        ...
                        <div class="card">
                            <div class="card-body flex_ gap-30">
                                ...
                                @if ($company->image != null)
                                    <img src="{{ asset('storage/companyLogo/' .$company->image) }}" alt="image">
                                @else
                                ...
                                @if ($top_rated_companies)
                                    @foreach ($top_rated_companies as $items)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a class="btn-broker1" href="{{ route('company.show', $items['comp_id']) }}">Review</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
