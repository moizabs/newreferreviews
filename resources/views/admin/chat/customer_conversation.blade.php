    ...
    <div class="flex min-h-screen bg-gray-200">
        <div class="w-72 divide-y overflow-y-auto bg-slate-300">
            ...
            @foreach($chats as $chat)
                @php
                    $chatId = $chat->last_msg2->message_by == 'USER' ? $chat->last_msg2->user_id : $chat->last_msg2->business_id;
                    
                @endphp
                <a href="#" onClick="chatId( {{ $chatId }} );">
                    <div role="button" class="sel-chat m-3 relative flex gap-3 bg-white p-2 transition-colors duration-300 hover:bg-slate-100">
                        ...
                        <div class="fle overflow-hidden">
                            ...
                            <div class="flex">
                              <p class="message text-sm font-semibold text-slate-500">{{ $chat->last_msg2->message }}</p>
