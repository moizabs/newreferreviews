...
<head>
    ...
    <title> Refer Reviews - Admin Request Price</title>
           ...
           <div class="app-main">
                ...
                <div class="scrollbar-sidebar my-4">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="adminpanel.html" class="mm-active">
                                    <i class="metismenu-icon fa-solid fa-rocket"></i>
                                    Dashboard
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse" style="height: 7.04px;">
                                    ...
                                    <li>
                                    <a href="userreviews.html" class="mm-active">
                                    <i class="metismenu-icon"></i> User Reviews
                                     </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse" style="height: 7.04px;">
                                    ...
                                    <li>
                                    <a href="buisnessreviews.html" class="mm-active">
                                    <i class="metismenu-icon"></i> Buisness Reviews
                                     </a>
                                    </li>
                                    <li>
                                    <a href="requestprice.html" class="">
            ...
            <div class="app-main__outer">
                <div class="container my-4">
                    <h5 style="font-size: 2.1rem; font-weight: 700;">Request Price</h5>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="mb-0 table">
                                            ...
                                            <tbody>
                                                @foreach($requestPrice as $item)
                                                <tr>
                                                    <td><b>1</b></td>
                                                    <td>{{ $item->get_business['comp_name'] }}</td>
                                                    <td>
                                                         <div class="flex-column d-flex">
                                                            
                                                            <span>{{ $item->get_customer['first_name'] }}</span>
                                                            <span>{{ $item->get_customer['email'] }}</span>
                                                            <span>{{ $item->get_customer['phone'] }}</span>
                                                        
                                                          </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex "><i class="fa-solid fa-location-dot mt-1 mr-2"></i>
                                                        <div style="color: red;">{{ $item->pickup_loca }} </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex "><i class="fa-solid fa-location-dot  mt-1 mr-2"></i>
                                                        <div style="color: green;">{{ $item->dilvery_loca }}
                                                        </div>
                                                         </div>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <span>{{ $item->veh_year.' '.$item->veh_make.' '.$item->veh_model}}</span>
                                                        @if($item->veh_condition == 1)
                                                        <span>(Running)</span>
                                                        @else
                                                        <span>(Not Running)</span>
                                                        @endif
                                                        
                                                        @if($item->trailer_types == 1)
                                                        <span>(Open)</span>
                                                        @else
                                                        <span>(Closed)</span>
                                                        @endif
                                                    ...
                                                    <td> 
                                                    @if($item->status == 1)
                                                        <a href="{{ route('admin.approved',$item->id) }}" class="btn btn-warning">Request Pending</a>
                                                    @else
                                                        <a href="{{ route('admin.approved',$item->id) }}" class="btn btn-success">Request Approved</a>
                                                    @endif
                                                    </td>
                                                </tr>
