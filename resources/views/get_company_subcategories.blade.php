...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 flex_ d-flex mt-2">
                                ...
                                <div class="card">
                                    <div class="card-body flex_ gap-30" style="align-items:center">
                                        <div class="companies-logo">
                                            @if(isset($searched_buss->image))
                                                <img src="{{ asset('storage/companyLogo/'.$searched_buss->image)}}" alt="image">
                                            @else
                                        ...
                                        <div>
                                            <div class="card-text">
                                                <a href="{{ route('company.show.review.page', $searched_buss->id) }}">{{ isset($searched_buss->comp_name) ? $searched_buss->comp_name : '' }}</a>
                                            </div>
                                            <div class="review-details">
                                                <div class="rate float-left">
                                                    @php
                                                        $stars = number_format(isset($searched_buss->avg[0]->totalRating) ? $searched_buss->avg[0]->totalRating : 0);
                                                    @endphp
                                                    {{-- Haseeb --}}
                                                    @for ($i = 1; $i <= $stars; $i++)
                                                ...
                                                <div>
                                                <h6>{{ isset($searched_buss->count_review[0]->totalReview) ? $searched_buss->count_review[0]->totalReview : 0 }} Reviews</h6>
                                                
                                                <div class="fl-header-phone-contain" data-toggle="modal" data-target="#Request-Price" style="cursor:pointer;">
                            ...
                            <div class="categories_list">
                                ...
                                @foreach($cate_comp as $comp )
                                    ...
                                    <div class="card-body flex_ gap-30" style="align-items:center">
                                        ...
                                        <div>
                                            <div class="card-text"><a href="{{ route('company.show.review.page', $comp->comp_info->id) }}">{{ isset($comp->comp_info->comp_name) ? $comp->comp_info->comp_name : '' }}</a></div>
                                            <div class="review-details">
                                                <div class="rate float-left">
                                                    @php
                            ...
                            <div class="styles_categoriesSideMenu__2kXgh">
                                ...
                                <div class="styles_listHolder__RtSGZ">
                                    ...
                                    <ul class="" id="subcat-list">
                                        @if(isset($categories->sub_category))
    ...
    <!-- Request Price Model -->
    <!--<div class="modal fade" id="Request-Price" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">-->
